...
class ProductIdentifier(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ProductIdentifier - a model defined in OpenAPI
