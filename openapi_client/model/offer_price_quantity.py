...
class OfferPriceQuantity(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OfferPriceQuantity - a model defined in OpenAPI
