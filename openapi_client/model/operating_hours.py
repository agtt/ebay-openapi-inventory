...
class OperatingHours(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'day_of_week_enum': (str,),  # noqa: E501
    ...
    attribute_map = {
        'day_of_week_enum': 'dayOfWeekEnum',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OperatingHours - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            intervals ([Interval]): This container is used to define the opening and closing times of a store's working day (defined in the dayOfWeekEnum field). An intervals container is needed for each day of the week that the store location is open. If a store location closes for lunch (or any other period during the day) and then reopens, multiple open and close pairs are needed This container is returned if operating hours are defined for the store location.. [optional]  # noqa: E501
        """
