...
class PublishByInventoryItemGroupRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PublishByInventoryItemGroupRequest - a model defined in OpenAPI
