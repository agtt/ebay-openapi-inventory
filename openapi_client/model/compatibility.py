...
class Compatibility(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'compatible_products': ([CompatibleProduct],),  # noqa: E501
            'sku': (str,),  # noqa: E501
        }
